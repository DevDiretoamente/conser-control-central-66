...
import { Vehicle, VehicleDocument } from '@/types/frota';
import VehicleDocumentManager from '../documents/VehicleDocumentManager';
...
const VehicleForm: React.FC<VehicleFormProps> = ({ vehicle, onSubmit, onCancel }) => {
  const [vehicleDocuments, setVehicleDocuments] = React.useState<VehicleDocument[]>(
    vehicle?.documents || []
  );
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Preencha as informações do veículo e gerencie seus documentos
        </p>
      </div>
